            ...
            >
                  ...
                  {contactInfo.map((info) => (
                    ...
                    >
                      <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center relative", info.bg)}>
                        <info.icon className={cn("w-6 h-6", info.color)} aria-hidden="true" />
                      </div>
                      <div>
                      ...
                      <ExternalLink className="w-4 h-4 ml-auto text-white/20 group-hover:text-primary transition-colors" aria-hidden="true" />
                    </a>
                  ))}
                </motion.div>
              </div>
              ...
              <motion.div variants={itemVariants}>
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border-white/5 relative">
                  ...
                  <form className="space-y-8 mt-4" onSubmit={handleSubmit} aria-label="Contact form">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-2">
                        <label htmlFor="contact-name" className="text-xs font-bold text-white/40 uppercase tracking-widest ml-4">Your Name</label>
                      ...
                      <div className="space-y-2">
                        <label htmlFor="contact-email" className="text-xs font-bold text-white/40 uppercase tracking-widest ml-4">Email Address</label>
                        <div className="relative">
                          <input 
                            id="contact-email"
                            required
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contact-project-type" className="text-xs font-bold text-white/40 uppercase tracking-widest ml-4">Project Type</label>
                      <div className="relative">
                        <select 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contact-message" className="text-xs font-bold text-white/40 uppercase tracking-widest ml-4">Project Details</label>
                      <div className="relative">
                        <textarea 
                          id="contact-message"
                          required
